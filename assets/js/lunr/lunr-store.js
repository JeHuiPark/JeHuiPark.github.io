var store = [{
        ...
        "teaser":null},{
        "title": "공부해라 제희야",
        "excerpt":"책책책책 제목 저자 이펙티브 자바 조슈아 블로크 클린코드 애자일 소프트웨어 장인정신 로버트C. 마틴 도메인 주도 설계 에릭 에반스 자바 ORM 표준 JPA 프로그래밍 김영한 오브젝트 조양호 헤드퍼스트 디자인패턴   GOF의 디자인패턴   켄트 벡의 구현 패턴   피플 웨어   알고리즘 로버트 세지윅 데이터 중심 애플리케이션 설계 마틴 클레프만 컴퓨팅...","categories": ["note"],
        "tags": [],
        "url": "https://jehuipark.github.io/note/study-todo-list",
        "teaser":null},{
        "title": "오브젝트",
